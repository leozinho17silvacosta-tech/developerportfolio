...
const About = () => {
  ...
  return (
    <section
      id="about"
      data-aos="fade-up"
      className="w-full py-10 md:py-20 px-4 sm:px-6 md:px-12 max-w-6xl mx-auto scroll-mt-24"
    >
      {/* TITLE: */}
      <div
        data-aos="fade-down"
      ...
      >
        ...
        <div className="h-1 w-16 bg-gradient-to-r from-transparent via-blue-700 to-transparent rounded mt-3 md:mt-4 mx-auto md:mx-0"></div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div
          data-aos="fade-left"
          data-aos-delay="200"
          className="md:col-span-7 space-y-4 md:space-y-6 text-center md:text-left w-full"
        >
          <h3 className="font-aldrich text-base sm:text-xl md:text-2xl text-zinc-800 dark:text-zinc-200">
            {t("aboutSubtitle")}
          </h3>

          <div className="space-y-3 sm:space-y-4 text-xs sm:text-base leading-relaxed text-zinc-600 dark:text-zinc-400 text-center md:text-left">
            <p>
              <Trans
                i18nKey="aboutBio1"
                components={{
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="300"
            className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-left text-xs sm:text-sm border-t border-zinc-200 dark:border-zinc-800 md:border-t-0"
          >
